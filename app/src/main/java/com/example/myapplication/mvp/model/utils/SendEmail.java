...
public class SendEmail {
    ...
    // 发件人
    private String from = "pyz66662021@163.com";     //你新注册的邮箱
    // 收件人
    ...
    public void sendTextEmail(long Num) throws Exception {
        ...
        // 打开连接
        transport.connect("pyz66662021", "AFNFFCXMFPYHHAPV");         //邮箱名字和刚才设置的授权密码
    ...
    static class MyAuthenticator extends Authenticator {
        ...
        private String username = "pyz66662021";     //邮箱名字

        private String password = "AFNFFCXMFPYHHAPV";     //邮箱授权密码
